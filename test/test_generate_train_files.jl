...
mkpath(joinpath(TEST_FILES_DIR, PowerSimulationNODE.INPUT_SYSTEM_FOLDER_NAME))

include(joinpath(TEST_FILES_DIR, "system_data/dynamic_components_data.jl"))

train_data_path =
    joinpath(TEST_FILES_DIR, PowerSimulationNODE.INPUT_FOLDER_NAME, "data.json")
train_system_path =
    joinpath(TEST_FILES_DIR, PowerSimulationNODE.INPUT_FOLDER_NAME, "system.json")
full_system_path = joinpath(
    TEST_FILES_DIR,
