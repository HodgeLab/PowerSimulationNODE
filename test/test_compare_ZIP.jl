...
@testset "Compare ZIP in Flux and PSID - FrequencyChirp" begin
    ...
    p = TrainParams(
        ...
        surrogate_buses = [2],
        model_params = ZIPParams(name = "source_surrogate"),
        train_data = (
            id = "1",
    ...
    P = get_activepower_series(results, "source_1")
    Q = get_reactivepower_series(results, "source_1")
